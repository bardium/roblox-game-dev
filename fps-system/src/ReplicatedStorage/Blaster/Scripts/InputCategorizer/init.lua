...
--[[
	By default, UserInputService reports last input type with high specificity: i.e. mouse, keyboard, gamepad1/2/3... etc.
	This utility library generalizes those input types into broader categories, making last input type easier to reason about.

	e.g. Since most keyboard users also have a mouse, keyboard and mouse are combined into a single category.
--]]
